...
class TSQLColumn():
    ...
    @classmethod
    def from_column(cls, sql_datatype: str, nullable: bool, column: Column, constraint: str = None):
        return cls(sql_datatype=sql_datatype, nullable=nullable, constraint=constraint, **asdict(column))
...
class TSQLDimDateColumns():
    def __init__(self, columns: DimDateColumns):
        self._columns: list[TSQLColumn] = [
            ...
            TSQLColumn.from_column('varchar(10)', False,
                                   columns.iso_date_name),
            TSQLColumn.from_column('varchar(10)', False,
                                   columns.american_date_name),
            TSQLColumn.from_column('varchar(9)', False,
                                   columns.day_of_week_name),
            TSQLColumn.from_column('varchar(3)', False,
                                   columns.day_of_week_abbrev),
            ...
            TSQLColumn.from_column('varchar(8)', False,
                                   columns.year_week_name),
            TSQLColumn.from_column('varchar(7)', False,
                                   columns.year_month_name),
            TSQLColumn.from_column('varchar(8)', False,
                                   columns.month_year_name),
            TSQLColumn.from_column('varchar(6)', False,
                                   columns.year_quarter_name),
            ...
            TSQLColumn.from_column(
                'int', False, columns.day_of_week_starting_monday),
            ...
            TSQLColumn.from_column(
                'int', False, columns.day_offset_from_today),
            TSQLColumn.from_column(
                'int', False, columns.month_offset_from_today),
            TSQLColumn.from_column(
                'int', False, columns.quarter_offset_from_today),
            TSQLColumn.from_column(
                'int', False, columns.year_offset_from_today),
            ...
            TSQLColumn.from_column(
                'date', False, columns.same_day_prior_month),
            TSQLColumn.from_column(
                'date', False, columns.same_day_prior_quarter),
            ...
            TSQLColumn.from_column(
                'date', False, columns.same_day_next_quarter),
            ...
            TSQLColumn.from_column(
                'date', False, columns.current_quarter_start),
            ...
            TSQLColumn.from_column(
                'bit', False, columns.weekly_burnup_starting_monday),
            ...
            TSQLColumn.from_column('varchar(8)', False,
                                   columns.fiscal_month_year_name),
            TSQLColumn.from_column('varchar(6)', False,
                                   columns.fiscal_year_quarter_name),
            ...
            TSQLColumn.from_column(
                'int', False, columns.fiscal_day_of_quarter),
            TSQLColumn.from_column('int', False, columns.fiscal_day_of_year),
            TSQLColumn.from_column(
                'int', False, columns.fiscal_week_of_quarter),
            TSQLColumn.from_column('int', False, columns.fiscal_week_of_year),
            TSQLColumn.from_column('int', False, columns.fiscal_month),
            TSQLColumn.from_column(
                'int', False, columns.fiscal_month_of_quarter),
            TSQLColumn.from_column('int', False, columns.fiscal_quarter),
            TSQLColumn.from_column('int', False, columns.fiscal_days_in_month),
            TSQLColumn.from_column(
                'int', False, columns.fiscal_days_in_quarter),
            TSQLColumn.from_column('int', False, columns.fiscal_days_in_year),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_current_month_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_prior_month_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_next_month_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_current_quarter_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_prior_quarter_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_next_quarter_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_current_year_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_prior_year_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_next_year_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_first_day_of_month_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_last_day_of_month_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_first_day_of_quarter_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_last_day_of_quarter_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_first_day_of_year_flag),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_last_day_of_year_flag),
            TSQLColumn.from_column('decimal(5,4)', False, columns.fiscal_fraction_of_month,
                                   f'chk_DimDate_{columns.fiscal_fraction_of_month.name} CHECK ({columns.fiscal_fraction_of_month.name} BETWEEN 0 AND 1)'),
            TSQLColumn.from_column('decimal(5,4)', False, columns.fiscal_fraction_of_quarter,
                                   f'chk_DimDate_{columns.fiscal_fraction_of_quarter.name} CHECK ({columns.fiscal_fraction_of_quarter.name} BETWEEN 0 AND 1)'),
            TSQLColumn.from_column('decimal(5,4)', False, columns.fiscal_fraction_of_year,
                                   f'chk_DimDate_{columns.fiscal_fraction_of_year.name} CHECK ({columns.fiscal_fraction_of_year.name} BETWEEN 0 AND 1)'),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_month_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_month_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_quarter_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_quarter_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_year_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_current_year_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_month_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_month_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_quarter_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_quarter_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_year_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_prior_year_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_month_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_month_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_quarter_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_quarter_end),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_year_start),
            TSQLColumn.from_column(
                'date', False, columns.fiscal_next_year_end),
            TSQLColumn.from_column(
                'bit', False, columns.fiscal_monthly_burnup),
            TSQLColumn.from_column(
