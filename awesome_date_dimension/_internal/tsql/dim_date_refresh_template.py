...
def dim_date_refresh_template(config: Config, columns: TSQLDimDateColumns) -> str:
    ...
    updatable_column_set = {
        dd_cols.day_offset_from_today.name,
        dd_cols.month_offset_from_today.name,
        dd_cols.quarter_offset_from_today.name,
        dd_cols.year_offset_from_today.name,
        dd_cols.today_flag.name,
        dd_cols.current_week_starting_monday_flag.name,
        dd_cols.current_week_flag.name,
        dd_cols.prior_week_flag.name,
        dd_cols.next_week_flag.name,
        dd_cols.current_month_flag.name,
        dd_cols.prior_month_flag.name,
        dd_cols.next_month_flag.name,
        dd_cols.current_quarter_flag.name,
        dd_cols.prior_quarter_flag.name,
        dd_cols.next_quarter_flag.name,
        dd_cols.current_year_flag.name,
        dd_cols.prior_year_flag.name,
        dd_cols.next_year_flag.name,
        dd_cols.weekly_burnup_starting_monday.name,
        dd_cols.weekly_burnup.name,
        dd_cols.monthly_burnup.name,
        dd_cols.quarterly_burnup.name,
        dd_cols.yearly_burnup.name,
        dd_cols.fiscal_current_month_flag.name,
        dd_cols.fiscal_prior_month_flag.name,
        dd_cols.fiscal_next_month_flag.name,
        dd_cols.fiscal_current_quarter_flag.name,
        dd_cols.fiscal_prior_quarter_flag.name,
        dd_cols.fiscal_next_quarter_flag.name,
        dd_cols.fiscal_current_year_flag.name,
        dd_cols.fiscal_prior_year_flag.name,
        dd_cols.fiscal_next_year_flag.name,
        dd_cols.fiscal_monthly_burnup.name,
        dd_cols.fiscal_quarterly_burnup.name,
        dd_cols.fiscal_yearly_burnup.name,
    }
    column_update_clause = ",\n    ".join(
        (f"d.{c.name} = dc.{c.name}" for c in columns if c.name in updatable_column_set)
    )
...
{holiday_join}
  ...
  UPDATE d
  SET
    {column_update_clause}{holiday_columns}
  FROM
    {dd_conf.table_schema}.{dd_conf.table_name} AS d
